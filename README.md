...
Para conectar-se ao MongoDB via linha de comando (cli) diretamente do docker-compose, execute:
...
## 👨‍💻 Desenvolvido por
* **Ranon Emerick** - *Construção, refatoração e implementação do código* - [Meu GitHub](https://github.com/ranonemerick)

## 🎓 Créditos e Agradecimentos
* Este projeto foi desenvolvido como parte de estudos práticos baseados no curso do **Victor Hugo Negrisoli**, focado em arquitetura de microsserviços e padrões de resiliência (Saga Pattern).
